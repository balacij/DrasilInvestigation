...
A chunk type that instantiates `ConceptDomain` means that the term defined by chunk type (i.e., the name of the chunk type) belongs to various domains (commonly captured with simple [[IdeaDict]]s):
